//------------------------------------------------------------------------------
//
// 2022.12.06 Header40 Pin test app for jig (charles-park)
//
// [wiringPi install]
...
//------------------------------------------------------------------------------
//
// WiringPi GPIO Document
//
// https://docs.google.com/spreadsheets/d/18cRWfgj9xmlr1JQb91fNN7SQxrBZxkHoxOEJN6Yy4SI/edit#gid=302752322
//
//------------------------------------------------------------------------------
//
// LCD:
...
// ODROID-M1
char *serialHandleNode = "/dev/ttyS0";

// ODROID-C4
// char *serialHandleNode = "/dev/ttyS1";
...
#if defined (__ODROID_M1S__)
    // M1S Header14 GPIO 116,117,107,108 (wiringpi 32,33,34,35)
    32,
    33,
    34,
    35
...
{
    printf("Usage: %s [-D]\n", prog);
    puts("  -D --device tty device name. (default /dev/ttyS0 for ODROID-M1).\n");
    exit(1);
}
